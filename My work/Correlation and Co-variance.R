...
#b
cor.test(cyl, hp) #based on the results, p value is highly significant which also means the correlation value going to be accordingly significant as well.

#c
cor.test(carb, gear) #based on the results, p value is high and notsignificant which also means the correlation value is weak as well (0.2740728).
